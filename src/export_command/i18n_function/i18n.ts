...
const i18nDefault: I18nInterface = {
    ...
    error: "Error: $1.",
    "error-add-web-site": "addWebCite ERROR: $1.",
    ...
    "error-no-username-or-password":
        "You have not filled in the user name or password, please go to the settings to edit them and try again.",
    ...
    "error-with-name": "ErrorName: $1, ErrorMessage: $2.",
    fail: "fail",
    false: "false",
    "from-to": "$1 => $2",
    ...
    "page-info-comment":
        "Please do not remove this struct. It's record contains some important informations of edit. This struct will be removed automatically after you push edits.",
    "pull-result-success": "",
    success: "success",
    true: "true",
...
const i18nChs: I18nInterface = {
    ...
    error: "错误：$1。",
    "error-add-web-site": "addWebCite 错误：$1。",
    ...
    "page-info-comment":
        "请不要删除此段落。它的记录包含了一些重要的编辑信息。提交编辑时，此段落将自动删除。",
